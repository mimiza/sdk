...
var LegacyAuthentication = /*#__PURE__*/function (_Component) {
  _inherits(LegacyAuthentication, _Component);

  var _super = _createSuper(LegacyAuthentication);

  function LegacyAuthentication() {
    var _this;

    _classCallCheck(this, LegacyAuthentication);
    ...
    _defineProperty(_assertThisInitialized(_this), "onSubmit", function (data) {
      ...
      if (typeof window !== 'undefined') {
        ...
        (0, _access.authenticate)(data.username, data.password, function (response) {
          _this.setState({
            processing: false
          });
  ...
  _createClass(LegacyAuthentication, [{
    key: "render",
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement(_Form["default"], {
        ...
        schema: [{
          ...
          name: 'login',
          type: 'button',
          className: 'button is-primary is-fullwidth' + (this.state.processing ? ' is-loading' : '')
        }]
      });
    }
  }]);
