...
var Youtube = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Youtube, [{
    ...
    value: function render() {
      ...
      var src = "https://www.youtube.com/embed/".concat(id);
      var thumbnail = "https://img.youtube.com/vi/".concat(id, "/hqdefault.jpg");

      var openModal = function openModal(src) {
        if (_this2.iframe.src !== src) _this2.iframe.src = src;
      ...
      return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement("figure", {
        ...
        style: {
          background: "radial-gradient(rgba(255, 255, 255, 1), rgba(189, 195, 199, 0.8)), url(\"".concat(thumbnail, "\") center center no-repeat"),
